	...
	<div class="container">
		...
		<table class="table table-striped">
			...
			<tr class="row">
				...
				<td>
					<%
						if (item.getRequestPicture() != null)
							out.print("사진&nbsp;");
						if (item.getConstCertificate() != null)
							out.print("건설안전교육이수증");
					%>
				...
				<td>
					<%
						...
						if (item.getLaunch() != null)
							out.print("점심&nbsp;&nbsp;");
						if (item.getEvening() != null)
							out.print("저녁&nbsp;&nbsp;");
						if (item.getCommute() != null)
							out.print("통근 차량&nbsp;&nbsp;");
						if (item.getOffWork() != null)
							out.print("퇴근 차량&nbsp;&nbsp;");
					%>
				</td>
			</tr>
						...
						<tbody>
							...
							<tr class="row">
								...
								<td class="col-sm-2 item"><a class="btn btn-sm btn-primary"
									href="seekerList.do?jobNumber=<%=jobList.get(i).getJobNumber()%>">신청관리</a></td>
							</tr>
							<%
								}
							%>
			...
			<tr class="row">
				...
				<td align="center"><input type="button"
					class="btn btn-block btn-info" type="button" value="인력관리">
				</td>
			</tr>
		</table>
	</div>
